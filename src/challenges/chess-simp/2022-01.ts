...
export class Simp_2022_01_29 implements Challenge {
  meta: Challenge['meta'] = {
    ...
    records: new Map([
      ...
      [users.Arnout.name, { when: new Date('2023-08-31'), depth: 1, moves: 41 }],
      [users.Erix.name, { when: new Date('2025-06-14'), depth: 3, moves: 39 }],
    ]),
  }
...
export class Simp_2022_01_21 implements Challenge {
  meta: Challenge['meta'] = {
    ...
    records: new Map([
      ...
      [users.Mendax.name, { when: new Date('2023-08-23'), depth: 4, moves: 29 }],
      [users.Arnout.name, { when: new Date('2023-08-31'), depth: 3, moves: 30 }],
    ]),
  }
