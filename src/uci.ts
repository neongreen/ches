  ...
  switch (move.kind) {
    case 'normal': {
      const promo = move.promotion
        ? pieceType(move.promotion) === PieceType.Knight
          ? 'n'
          : pieceType(move.promotion) === PieceType.Bishop
          ? 'b'
          : pieceType(move.promotion) === PieceType.Rook
          ? 'r'
          : pieceType(move.promotion) === PieceType.Queen
          ? 'q'
          : ''
        : ''
